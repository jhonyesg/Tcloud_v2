...
El sistema SHALL permitir al admin registrar una fila en `user_alerts_inteligentes` por usuario con `enabled=true`, `keywords_quota` (ej. 100, 200) y `emails_quota` (cantidad máxima de correos que el usuario puede tener registrados).

...
- **THEN** dispone de las acciones de la fila: "Ver" (modal unificado con el medio iniciando en el minuto de la mención y su transcripción anclada), "Editor" para generar corte (según capabilities) y "Archivos" para abrir el módulo de archivos en la carpeta del medio con el archivo resaltado (según permisos)

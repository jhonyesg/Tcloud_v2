...
- [ ] 3.1 Run backup script manually to create initial backup of current database
- [ ] 3.2 Verify backup file exists in `backup/db/` and is valid gzip

## 4. Cron Setup

- [ ] 4.1 Add cron job entry for daily execution (e.g., `0 2 * * *` for 2 AM daily)

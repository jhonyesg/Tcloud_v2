...
- **WHEN** el administrador está en la página 3 y hace clic en
  "Siguiente" de la paginación superior
- **THEN** la URL contiene `&page=4` y la tabla carga la página 4 sin
  requerir scroll al final

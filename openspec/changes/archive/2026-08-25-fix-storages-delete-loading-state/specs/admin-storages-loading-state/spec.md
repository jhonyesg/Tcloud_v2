...
El sistema SHALL garantizar que cualquier estado de carga establecido por estas dos operaciones (`deletingStorageId`, `removingUserAssignmentId`) se limpie cuando la petición termina, sin importar si termina con éxito, error, excepción de red o timeout — para que la UI nunca quede bloqueada.

...
class TranscriptorSettings
{
    ...
    private const SCHEMA = [
        ...
        'dispatch_stagger_ms' => [
            'type' => 'int', 'group' => 'ritmo', 'default' => 250, 'min' => 0, 'max' => 5000,
        ...
        'stagger_chunk_size' => [
            ...
            'help' => 'El batch se divide en chunks de este tamano y se reparten con dispatch_stagger_ms entre cada uno.',
        ],
        ...
        'regulator_remote_cache_seconds' => [
            ...
            'help' => 'TTL en Redis de la lectura de /api/info. Bajo para no castigar al nodo ASR; alto para menos latencia.',
        ],

        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($stats['total_users']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($stats['total_storages']); ?></p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($stats['total_files']); ?></p>
                </div>
            ...
            <div class="mt-4 flex items-center text-sm text-slate-400">
                <?php echo e(number_format($stats['storage_used'] / 1024 / 1024, 2)); ?> MB usados
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-5 hover:shadow-md transition-shadow">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-slate-800 mt-1"><?php echo e($stats['total_shares']); ?></p>
                </div>
                <div class="w-12 h-12 bg-brand-100 rounded-xl flex items-center justify-center">
            ...
            <div class="space-y-5">
                <div>
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <span class="font-medium text-slate-800"><?php echo e($stats['total_users']); ?></span>
                    </div>
                ...
                <div>
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <span class="font-medium text-slate-800"><?php echo e(number_format($stats['storage_used'] / 1024 / 1024, 2)); ?> MB</span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-2">
                ...
                <div>
                    <div class="flex justify-between text-sm mb-2">
                        ...
                        <span class="font-medium text-slate-800"><?php echo e($stats['total_shares']); ?></span>
                    </div>
                    <div class="w-full bg-slate-100 rounded-full h-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/dashboard/admin.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Asignar Storages - ' . $targetUser->email . ' - Tcloud'); ?>
...
<div class="p-6" x-data="{
    ...
    async loadData() {
        const userId = <?php echo e($targetUser->id); ?>;
    ...
    <div class="flex justify-between items-center mb-6">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Storages de: <?php echo e($targetUser->email); ?></h1>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/user-storages.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Mi Perfil - Tcloud'); ?>
        ...
        <div class="text-left">
            ...
            <div>
                ...
                <p class="info-value">
                    <span class="role-badge <?php echo e($user->role === 'admin' ? 'admin' : 'user'); ?>">
                        <i class="fas <?php echo e($user->role === 'admin' ? 'fa-shield-alt' : 'fa-user'); ?>"></i>
            ...
            <div class="quota-section">
                <div class="quota-header">
                    ...
                    <span class="quota-value"><?php echo e($usedFormatted); ?> / <?php echo e($quotaFormatted); ?></span>
                </div>
                <div class="quota-bar">
                    <div class="quota-bar-fill" style="width: <?php echo e($quotaPercent); ?>%"></div>
                </div>
            </div>
        </div>

<?php $__env->startSection('title', 'PostgreSQL Admin - Tcloud'); ?>
...
function jsonData() {
    return {
        activeTab: 'config',
        config: {
            host: '<?php echo e(env("PG_HOST", "postgres")); ?>',
            port: '<?php echo e(env("PG_PORT", "5432")); ?>',
            database: '<?php echo e(env("PG_DATABASE", "tcloudstorage")); ?>',
            username: '<?php echo e(env("PG_USERNAME", "cloud")); ?>',
            password: ''
        },
        ftp: {
            host: '<?php echo e(env("FTP_HOST", "")); ?>',
            port: '<?php echo e(env("FTP_PORT", "21")); ?>',
            username: '<?php echo e(env("FTP_USERNAME", "")); ?>',
            password: '',
            path: '<?php echo e(env("FTP_PATH", "/")); ?>'
        },
        testResult: null,
        testing: false,
        schemaTables: [],
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/postgres.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'Vista Previa - ' . $file->name); ?>
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="bg-[#0A1F4D] p-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    <a href="<?php echo e(route('share.folder', ['token' => $share->token, 'folder_id' => $file->parent_id ?? $share->file_id])); ?>" class="text-white hover:text-blue-200">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"/>
                        </svg>
                    </a>
                    <h1 class="text-lg font-bold text-white"><?php echo e($file->name); ?></h1>
                </div>
                <a href="<?php echo e($previewUrl); ?>" class="flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white px-4 py-2 rounded-lg text-sm transition-colors">
            ...
            <div class="p-6 bg-slate-100">
                <?php if(str_starts_with($mimeType, 'image/')): ?>
                    <div class="flex justify-center bg-white rounded-xl overflow-hidden">
                        <img src="<?php echo e($previewUrl); ?>" alt="<?php echo e($file->name); ?>" class="max-w-full object-contain" style="max-height: 70vh;">
                    </div>
                ...
                <?php elseif(str_starts_with($mimeType, 'video/')): ?>
                    <div class="flex flex-col items-center bg-white rounded-xl p-4">
                        <video controls class="w-full max-w-4xl rounded-lg" style="max-height: 70vh;">
                            <source src="<?php echo e($previewUrl); ?>" type="<?php echo e($mimeType); ?>">
                ...
                <?php elseif(str_starts_with($mimeType, 'audio/')): ?>
                    <div class="flex flex-col items-center justify-center bg-white rounded-xl p-8">
                        ...
                        <p class="text-lg font-medium mb-4 text-slate-800"><?php echo e($file->name); ?></p>
                ...
                <?php elseif($mimeType === 'application/pdf'): ?>
                    <div class="bg-white rounded-xl overflow-hidden" style="height: 80vh;">
                        <iframe src="<?php echo e($previewUrl); ?>" class="w-full h-full" style="min-height: 80vh;"></iframe>
                    </div>
                ...
                <?php else: ?>
                    <div class="flex flex-col items-center justify-center bg-white rounded-xl p-12">
                        ...
                        <a href="<?php echo e($previewUrl); ?>" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-medium transition-colors">
                            Descargar archivo
                        </a>
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/shares/preview.blade.php ENDPATH**/ ?>